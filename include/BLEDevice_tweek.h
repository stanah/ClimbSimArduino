...
typedef void (*gattc_event_handler)(esp_gattc_cb_event_t event, esp_gatt_if_t gattc_if,
                                    esp_ble_gattc_cb_param_t* param);
typedef void (*gatts_event_handler)(esp_gatts_cb_event_t event, esp_gatt_if_t gattc_if,
...
class BLEDevice {
 public:
  ...
  static std::string getValue(
      BLEAddress bdAddress, BLEUUID serviceUUID,
  ...
  static void setValue(
      BLEAddress bdAddress, BLEUUID serviceUUID, BLEUUID characteristicUUID,
 ...
 private:
  ...
  static void gattClientEventHandler(esp_gattc_cb_event_t event, esp_gatt_if_t gattc_if,
                                     esp_ble_gattc_cb_param_t* param);

  static void gattServerEventHandler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if,
                                     esp_ble_gatts_cb_param_t* param);
